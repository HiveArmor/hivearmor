...
import com.hivearmor.userauditor.service.elasticsearch.utils.exception.exceptions.UtmElasticsearchException;
...
public class ElasticsearchService {
    ...
    public boolean indexExist(String index) {
        ...
        try {
            return client.getClient().indices().exists(r -> r.index(index)).value();
        } catch (Exception e) {
