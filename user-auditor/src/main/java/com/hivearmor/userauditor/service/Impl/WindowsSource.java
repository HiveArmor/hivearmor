package com.hivearmor.userauditor.service.Impl;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.hivearmor.userauditor.model.*;
import com.hivearmor.userauditor.model.event.Event;
import com.hivearmor.userauditor.model.event.UserEvent;
import com.hivearmor.userauditor.repository.SourceScanRepository;
import com.hivearmor.userauditor.service.elasticsearch.ElasticsearchService;
import com.hivearmor.userauditor.service.elasticsearch.SearchUtil;
import com.hivearmor.userauditor.service.interfaces.Source;
import com.hivearmor.userauditor.service.type.FilterType;
import com.hivearmor.userauditor.service.type.OperatorType;
...
public class WindowsSource implements Source {
    ...
    private static SearchRequest.Builder getBuilder(SourceFilter sourceFilter, List<String> range, String after) {
        ...
        srb.aggregations(Map.of(TARGET_AGG_NAME,
                    CompositeAggregationBuilder.buildCompositeTermAggregation(FIELD, "users", ITEMS_PER_PAGE, after)));
        return srb;
    }
