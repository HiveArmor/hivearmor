 ...
 *   <li>Valid JSON with an invalid {@code riskLevel} (including empty string,
 *       "EXTREME", uppercase variants) → normalised to {@code "medium"}.</li>
 ...
 *   <li>Direct {@code normalizeRiskLevel} call with arbitrary strings → always valid.</li>
 * </ol>
 *
...
class HaAiChatRiskLevelPropertyTest {
     ...
     *
     * <p>When the LLM returns a completely non-JSON string, {@code parseSummaryOrFallback}
     * must return the medium-severity fallback DTO. After normalisation the riskLevel
     * must be {@code "medium"}.
     *
     * <p><strong>Validates: Requirements 17.7, 17.8</strong>
     */
     ...
     *
     * <p>For any arbitrary string (including {@code null}) passed as {@code riskLevel}
     * in a DTO, {@code normalizeRiskLevel} must always return a DTO whose
     * {@code riskLevel} is a member of {@code {low, medium, high, critical}}.
     *
     * <p><strong>Validates: Requirements 17.7, 17.8, 18.5</strong>
     */
    @Property(tries = 200)
