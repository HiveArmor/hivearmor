...
import com.hivearmor.util.enums.AlertActionEnum;
...
public class AlertLoggingAspect {
    ...
    @Pointcut("execution(void com.hivearmor.service.impl.UtmAlertServiceImpl.updateTags(..))")
    public void manualAlertTagsChangePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    @Pointcut("execution(void com.hivearmor.service.impl.UtmAlertServiceImpl.updateNotes(..))")
    public void manualAlertNotesChangePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    @Pointcut("execution(void com.hivearmor.aop.pointcut.AlertPointcut.automaticAlertStatusChangePointcut(..))")
    public void automaticAlertStatusChangePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    @Pointcut("execution(void com.hivearmor.aop.pointcut.AlertPointcut.automaticAlertTagsChangePointcut(..))")
    public void automaticAlertTagsChangePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    @Pointcut("execution(void com.hivearmor.aop.pointcut.AlertPointcut.convertToIncidentPointcut(..))")
