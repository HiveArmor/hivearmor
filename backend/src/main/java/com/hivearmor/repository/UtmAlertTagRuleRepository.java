...
public interface UtmAlertTagRuleRepository extends JpaRepository<UtmAlertTagRule, Long> {
    ...
    @Query(nativeQuery = true, value = "select uatr.* from hive_alert_tag_rule uatr where " +
    ...
    Page<UtmAlertTagRule> findByFilter(@Param("id") TypedParameterValue<Long> id,
                                       @Param("name") TypedParameterValue<String> name,
                                       @Param("conditionField") TypedParameterValue<String> conditionField,
                                       @Param("conditionValue") TypedParameterValue<String> conditionValue,
                                       @Param("tagIds") TypedParameterValue<String> tagIds,
                                       @Param("isActive") TypedParameterValue<Boolean> isActive,
                                       @Param("isDeleted") TypedParameterValue<Boolean> isDeleted,
                                       Pageable pageable);
