...
public final class Constants {
    ...
    public static final String PROP_MAIL_HOST = "hivearmor.mail.host";
    public static final String PROP_MAIL_PORT = "hivearmor.mail.port";
    public static final String PROP_MAIL_PASSWORD = "hivearmor.mail.password";
    public static final String PROP_MAIL_USERNAME = "hivearmor.mail.username";
    public static final String PROP_MAIL_ORGNAME = "hivearmor.mail.organization";
    public static final String PROP_MAIL_SMTP_AUTH = "hivearmor.mail.properties.mail.smtp.auth";
    ...
    public static final String PROP_MAIL_FROM = "hivearmor.mail.from";
    public static final String PROP_MAIL_BASE_URL = "hivearmor.mail.baseUrl";
    public static final String PROP_TWILIO_ACCOUNT_SID = "hivearmor.twilio.accountSid";
    public static final String PROP_TWILIO_AUTH_TOKEN = "hivearmor.twilio.authToken";
    public static final String PROP_TWILIO_NUMBER = "hivearmor.twilio.number";
    public static final String PROP_ALERT_ADDRESS_TO_NOTIFY_ALERTS = "hivearmor.alert.addressToNotifyAlerts";
    public static final String PROP_ALERT_ADDRESS_TO_NOTIFY_INCIDENTS = "hivearmor.alert.addressToNotifyIncidents";
    public static final String PROP_DATE_SETTINGS_TIMEZONE = "hivearmor.time.zone";
    public static final String PROP_NETWORK_SCAN_API_URL = "hivearmor.networkScan.apiUrl";
    public static final String PROP_TFA_ENABLE = "hivearmor.tfa.enable";
    public static final String PROP_TFA_METHOD = "hivearmor.tfa.method";
    ...
    public static final String TFA_ISSUER = "HiveArmor";
    ...
    /** Document field used by v3 alert indexes (e2e + current pipeline). */
    public static final String alertDocumentIdKeyword = "alertId.keyword";
    ...
    // ----------------------------------------------------------------------------------
    public static final String STATISTICS_INDEX_PATTERN = "v3-hive-statistics-*";
    public static final String V11_API_ACCESS_LOGS = "v3-hive-api-access-logs-*";
    public static final String V11_ALERTS_INDEX_PATTERN = "v3-hive-alert-*";
    ...
    public static final String APP_FILTER_DEFINITIONS = "/hivearmor/filters";
    public static final String APP_RULE_DEFINITIONS = "/hivearmor/rules";
