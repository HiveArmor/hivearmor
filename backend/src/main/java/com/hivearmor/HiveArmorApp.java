...
import com.hivearmor.config.DefaultProfileUtil;
...
public class HiveArmorApp {

    private static final Logger log = LoggerFactory.getLogger(HiveArmorApp.class);

    private final Environment env;


    public HiveArmorApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes HiveArmor.
     * <p>
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(HiveArmorApp.class);
