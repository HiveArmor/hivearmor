...
public class UtmDataTypes implements Serializable {
    ...
    private com.hivearmor.domain.application_modules.UtmModule module;
    ...
    public com.hivearmor.domain.application_modules.UtmModule getModule() {
        return module;
    }

    public void setModule(com.hivearmor.domain.application_modules.UtmModule module) {
        this.module = module;
    }
}
