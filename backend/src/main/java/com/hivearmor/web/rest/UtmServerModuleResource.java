...
import com.hivearmor.service.UtmServerModuleQueryService;
import com.hivearmor.service.UtmServerModuleService;
import com.hivearmor.service.application_events.ApplicationEventService;
import com.hivearmor.service.dto.UtmServerModuleCriteria;
...
public class UtmServerModuleResource {
    ...
    public ResponseEntity<UtmServerModule> createUtmServerModule(@RequestBody UtmServerModule utmServerModule) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ha-server-modules/" + result.getId()))
    ...
    public ResponseEntity<List<UtmServerModule>> getAllUtmServerModules(UtmServerModuleCriteria criteria, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-server-modules");
     ...
     */
    @GetMapping("/ha-server-modules/count")
     ...
     */
    @GetMapping("/ha-server-modules/{id}")
     ...
     */
    @DeleteMapping("/ha-server-modules/{id}")
    @AuditEvent(
    ...
    @GetMapping("/ha-server-modules/modules-with-integrations")
