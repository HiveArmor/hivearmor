...
import com.hivearmor.domain.incident_response.UtmIncidentActionCommand;
import com.hivearmor.service.application_events.ApplicationEventService;
import com.hivearmor.service.dto.incident_response.UtmIncidentActionCommandCriteria;
import com.hivearmor.service.incident_response.UtmIncidentActionCommandQueryService;
import com.hivearmor.service.incident_response.UtmIncidentActionCommandService;
...
public class UtmIncidentActionCommandResource {
    ...
    public ResponseEntity<List<UtmIncidentActionCommand>> getAllIncidentActionCommands(UtmIncidentActionCommandCriteria criteria, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-incident-action-commands");
