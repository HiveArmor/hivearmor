...
import com.hivearmor.service.UtmAlertTagQueryService;
import com.hivearmor.service.UtmAlertTagService;
import com.hivearmor.service.application_events.ApplicationEventService;
import com.hivearmor.service.dto.UtmAlertTagCriteria;
...
public class UtmAlertTagResource {
    ...
    public ResponseEntity<UtmAlertTag> createUtmAlertTag(@Valid @RequestBody UtmAlertTag alertTag) {
        ...
        try {
            ...
            return ResponseEntity.created(new URI("/api/ha-alert-tags/" + result.getId())).headers(
    ...
    public ResponseEntity<List<UtmAlertTag>> getAllUtmAlertCategories(UtmAlertTagCriteria criteria, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-alert-tags");
     ...
     */
    @DeleteMapping("/ha-alert-tags/{id}")
