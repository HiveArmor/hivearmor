package com.hivearmor.web.rest.index_pattern;
...
import com.hivearmor.service.dto.index_pattern.UtmIndexPatternCriteria;
import com.hivearmor.service.dto.index_pattern.UtmIndexPatternField;
import com.hivearmor.service.index_pattern.UtmIndexPatternQueryService;
...
public class UtmIndexPatternResource {
    ...
    public ResponseEntity<List<UtmIndexPattern>> getAllUtmIndexPatterns(UtmIndexPatternCriteria criteria,
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-index-patterns");
    ...
    @GetMapping("/ha-index-patterns/fields")
    public ResponseEntity<List<UtmIndexPatternField>> getAllUtmIndexPatternsWithFields(UtmIndexPatternCriteria criteria,
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-index-patterns-fields");
            return ResponseEntity.ok().headers(headers).body(page.getContent());
        } catch (Exception e) {
            String msg = ctx + ": " + e.getMessage();
            log.error(msg);
     ...
     */
    @GetMapping("/ha-index-patterns/{id}")
     ...
     */
    @DeleteMapping("/ha-index-patterns/{id}")
