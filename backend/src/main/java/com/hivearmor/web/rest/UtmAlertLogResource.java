...
import com.hivearmor.service.UtmAlertLogQueryService;
import com.hivearmor.service.UtmAlertLogService;
import com.hivearmor.service.application_events.ApplicationEventService;
import com.hivearmor.service.dto.UtmAlertLogCriteria;
...
public class UtmAlertLogResource {
    ...
    public ResponseEntity<UtmAlertLog> createUtmAlertLog(@Valid @RequestBody UtmAlertLog utmAlertLog) throws URISyntaxException {
        ...
        try {
            ...
            return ResponseEntity.created(new URI("/api/ha-alert-logs/" + result.getId()))
    ...
    public ResponseEntity<List<UtmAlertLog>> getAllUtmAlertLogs(UtmAlertLogCriteria criteria, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-alert-logs");
     ...
     */
    @GetMapping("/ha-alert-logs/count")
     ...
     */
    @DeleteMapping("/ha-alert-logs/{id}")
