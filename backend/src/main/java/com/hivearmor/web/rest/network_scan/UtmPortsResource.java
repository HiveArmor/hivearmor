...
import com.hivearmor.domain.network_scan.UtmPorts;
import com.hivearmor.service.dto.network_scan.UtmPortsCriteria;
import com.hivearmor.service.network_scan.UtmPortsQueryService;
import com.hivearmor.service.network_scan.UtmPortsService;
...
public class UtmPortsResource {
    ...
    public ResponseEntity<UtmPorts> createUtmOpenPort(@RequestBody UtmPorts utmPort) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ha-open-ports/" + result.getId()))
    ...
    public ResponseEntity<List<UtmPorts>> getAllUtmOpenPorts(UtmPortsCriteria criteria, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-open-ports");
     ...
     */
    @GetMapping("/ha-open-ports/count")
     ...
     */
    @DeleteMapping("/ha-open-ports/{id}")
