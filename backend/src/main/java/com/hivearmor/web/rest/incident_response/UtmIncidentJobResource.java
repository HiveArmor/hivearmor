...
import com.hivearmor.service.dto.incident_response.UtmIncidentJobCriteria;
import com.hivearmor.service.incident_response.UtmIncidentJobQueryService;
...
public class UtmIncidentJobResource {
    ...
    public ResponseEntity<List<UtmIncidentJob>> getAllUtmIncidentJobs(UtmIncidentJobCriteria criteria, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-incident-jobs");
     ...
     */
    @GetMapping("/ha-incident-jobs/count")
     ...
     */
    @GetMapping("/ha-incident-jobs/{id}")
     ...
     */
    @DeleteMapping("/ha-incident-jobs/{id}")
