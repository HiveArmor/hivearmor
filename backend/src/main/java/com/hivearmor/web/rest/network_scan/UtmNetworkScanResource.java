...
import com.hivearmor.service.dto.network_scan.NetworkScanDTO;
import com.hivearmor.service.dto.network_scan.UtmNetworkScanCriteria;
import com.hivearmor.service.network_scan.UtmNetworkScanQueryService;
...
public class UtmNetworkScanResource {
    ...
    @PostMapping("/ha-network-scans/saveOrUpdateCustomAsset")
    ...
    @PutMapping("/ha-network-scans/updateType")
    ...
    @PutMapping("/ha-network-scans/updateGroup")
    ...
    public ResponseEntity<List<UtmNetworkScan>> getAllUtmNetworkScans(UtmNetworkScanCriteria criteria, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-network-scans");
     ...
     */
    @GetMapping("/ha-network-scans/count")
     ...
     */
    @GetMapping("/ha-network-scans/{id}")
    ...
    @GetMapping("/ha-network-scans/search-by-filters")
    public ResponseEntity<List<NetworkScanDTO>> searchByFilters(@ParameterObject NetworkScanFilter filters,
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-network-scans/search-by-filters");
            return ResponseEntity.ok().headers(headers).body(page.getContent());
        } catch (Exception e) {
            String msg = ctx + ": " + e.getMessage();
            log.error(msg);
    ...
    @GetMapping("/ha-network-scans/searchPropertyValues")
    ...
    @GetMapping("/ha-network-scans/countNewAssets")
    ...
    @GetMapping("/ha-network-scans/getNetworkScanReport")
    ...
    @DeleteMapping("/ha-network-scans/deleteCustomAsset/{id}")
    ...
    @GetMapping("/ha-network-scans/can-run-command")
    ...
    @GetMapping("/ha-network-scans/agent-os-platform")
