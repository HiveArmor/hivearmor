package com.hivearmor.web.rest.reports;

import com.hivearmor.domain.application_events.enums.ApplicationEventType;
import com.hivearmor.domain.reports.UtmReportSection;
import com.hivearmor.service.application_events.ApplicationEventService;
import com.hivearmor.service.dto.reports.UtmReportSectionCriteria;
import com.hivearmor.service.reports.UtmReportSectionQueryService;
import com.hivearmor.service.reports.UtmReportSectionService;
...
public class UtmReportSectionResource {
     ...
     */
    @PostMapping("/ha-report-sections")
    public ResponseEntity<UtmReportSection> createUtmReportSection(@Valid @RequestBody UtmReportSection utmReportSection) {
        ...
        try {
            ...
            return ResponseEntity.created(new URI("/api/ha-report-sections/" + result.getId()))
    ...
    public ResponseEntity<List<UtmReportSection>> getAllUtmReportSections(UtmReportSectionCriteria criteria, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-report-sections");
     ...
     */
    @GetMapping("/ha-report-sections/count")
     ...
     */
    @GetMapping("/ha-report-sections/{id}")
     ...
     */
    @DeleteMapping("/ha-report-sections/{id}")
