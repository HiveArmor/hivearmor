...
import com.hivearmor.service.dto.incident.UtmIncidentHistoryCriteria;
import com.hivearmor.service.incident.UtmIncidentHistoryQueryService;
import com.hivearmor.service.incident.UtmIncidentHistoryService;
...
public class UtmIncidentHistoryResource {
     ...
     */
    @GetMapping("/ha-incident-histories")
    public ResponseEntity<List<UtmIncidentHistory>> getAllUtmIncidentHistories(UtmIncidentHistoryCriteria criteria, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-incident-histories");
     ...
     */
    @GetMapping("/ha-incident-histories/count")
     ...
     */
    @GetMapping("/ha-incident-histories/{id}")
...
//     */
//    @PostMapping("/ha-incident-histories")
...
//            return ResponseEntity.created(new URI("/api/ha-incident-histories/" + result.getId()))
