...
import com.hivearmor.service.UtmAssetMetricsService;
...
public class UtmAssetMetricsResource {
    ...
    public ResponseEntity<UtmAssetMetrics> createUtmAssetMetrics(@Valid @RequestBody UtmAssetMetrics utmAssetMetrics) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ha-asset-metrics/" + result.getId()))
     ...
     */
    @GetMapping("/ha-asset-metrics/{id}")
     ...
     */
    @DeleteMapping("/ha-asset-metrics/{id}")
