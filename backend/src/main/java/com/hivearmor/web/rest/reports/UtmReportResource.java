...
import com.hivearmor.domain.reports.UtmReport;
import com.hivearmor.service.application_events.ApplicationEventService;
import com.hivearmor.service.dto.reports.UtmReportCriteria;
import com.hivearmor.service.reports.UtmReportQueryService;
import com.hivearmor.service.reports.UtmReportService;
...
public class UtmReportResource {
    ...
    public ResponseEntity<UtmReport> createUtmReports(@Valid @RequestBody UtmReport utmReports) {
        ...
        try {
            ...
            return ResponseEntity.created(new URI("/api/ha-reports/" + result.getId()))
    ...
    public ResponseEntity<List<UtmReport>> getAllUtmReports(UtmReportCriteria criteria, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-reports");
