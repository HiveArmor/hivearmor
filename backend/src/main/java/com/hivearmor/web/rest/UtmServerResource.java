...
import com.hivearmor.service.UtmServerQueryService;
import com.hivearmor.service.UtmServerService;
import com.hivearmor.service.dto.UtmServerCriteria;
...
public class UtmServerResource {
    ...
    public ResponseEntity<UtmServer> createUtmServer(@RequestBody UtmServer utmServer) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ha-servers/" + result.getId()))
    ...
    public ResponseEntity<List<UtmServer>> getAllUtmServers(UtmServerCriteria criteria, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-servers");
