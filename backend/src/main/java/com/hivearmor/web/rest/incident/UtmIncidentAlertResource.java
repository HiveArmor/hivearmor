...
import com.hivearmor.service.dto.incident.UtmIncidentAlertCriteria;
import com.hivearmor.service.incident.UtmIncidentAlertQueryService;
import com.hivearmor.service.incident.UtmIncidentAlertService;
...
public class UtmIncidentAlertResource {
     ...
     */
    @PostMapping("/ha-incident-alerts")
    public ResponseEntity<UtmIncidentAlert> createUtmIncidentAlert(@Valid @RequestBody UtmIncidentAlert utmIncidentAlert) throws URISyntaxException {
        ...
        try {
            ...
            return ResponseEntity.created(new URI("/api/ha-incident-alerts/" + result.getId()))
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/ha-incident-alerts/update-status")
    ...
    public ResponseEntity<List<UtmIncidentAlert>> getAllUtmIncidentAlerts(UtmIncidentAlertCriteria criteria, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-incident-alerts");
     ...
     */
    @DeleteMapping("/ha-incident-alerts/{id}")
