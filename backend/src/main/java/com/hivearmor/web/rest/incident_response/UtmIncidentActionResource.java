...
import com.hivearmor.domain.incident_response.UtmIncidentAction;
import com.hivearmor.security.SecurityUtils;
import com.hivearmor.service.application_events.ApplicationEventService;
import com.hivearmor.service.dto.incident_response.UtmIncidentActionCriteria;
import com.hivearmor.service.incident_response.UtmIncidentActionQueryService;
import com.hivearmor.service.incident_response.UtmIncidentActionService;
...
public class UtmIncidentActionResource {
     ...
     */
    @PostMapping("/ha-incident-actions")
     ...
     * couldn't be updated
     */
    @PutMapping("/ha-incident-actions")
     ...
     */
    @GetMapping("/ha-incident-actions")
    public ResponseEntity<List<UtmIncidentAction>> getAllUtmIncidentActions(UtmIncidentActionCriteria criteria,
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-incident-actions");
     ...
     */
    @GetMapping("/ha-incident-actions/count")
     ...
     */
    @GetMapping("/ha-incident-actions/{id}")
     ...
     */
    @DeleteMapping("/ha-incident-actions/{id}")
