...
public class UtmMenuAuthorityResource {
     ...
     */
    @PostMapping("/ha-menu-authorities")
    public ResponseEntity<UtmMenuAuthority> createUtmMenuAuthority(
        ...
        try {
            ...
            return ResponseEntity.created(new URI("/api/ha-menu-authorities/" + result.getId())).headers(
     ...
     */
    @PutMapping("/ha-menu-authorities")
     ...
     */
    @GetMapping("/ha-menu-authorities")
     ...
     */
    @GetMapping("/ha-menu-authorities/{id}")
     ...
     */
    @DeleteMapping("/ha-menu-authorities/{id}")
