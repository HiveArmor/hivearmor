package com.hivearmor.web.rest.user_auditor;

import com.hivearmor.config.Constants;
import com.hivearmor.service.dto.user_auditor.UtmAuditorUsersDTO;
import com.hivearmor.util.ResponseUtil;
import com.hivearmor.web.rest.user_auditor.dto.MicroserviceRequest;
...
public class UtmAuditorUsersResource {
    ...
    public ResponseEntity<List<UtmAuditorUsersDTO>> getAllUtmAuditorUsers(Pageable pageable, Long sourceId) {
        ...
        try {
            ...
            String uri = microServiceUrl.concat("/ha-auditor-users-by-src?page={page}&size={size}&sort={sort}&id={id}");
