...
import com.hivearmor.domain.incident_response.UtmIncidentVariable;
import com.hivearmor.security.SecurityUtils;
import com.hivearmor.service.application_events.ApplicationEventService;
import com.hivearmor.service.dto.incident_response.UtmIncidentVariableCriteria;
import com.hivearmor.service.incident_response.UtmIncidentVariableQueryService;
...
public class UtmIncidentVariableResource {
     ...
     */
    @PostMapping("/ha-incident-variables")
     ...
     * couldn't be updated
     */
    @PutMapping("/ha-incident-variables")
     ...
     */
    @GetMapping("/ha-incident-variables")
     ...
     */
    @DeleteMapping("/ha-incident-variables/{id}")
