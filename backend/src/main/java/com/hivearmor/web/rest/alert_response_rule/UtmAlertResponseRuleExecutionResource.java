...
import com.hivearmor.service.alert_response_rule.UtmAlertResponseRuleExecutionQueryService;
import com.hivearmor.service.application_events.ApplicationEventService;
import com.hivearmor.service.dto.UtmAlertResponseRuleExecutionCriteria;
...
public class UtmAlertResponseRuleExecutionResource {
    ...
    @GetMapping("/ha-alert-response-rule-executions")
    public ResponseEntity<List<UtmAlertResponseRuleExecution>> getAllAlertResponseRuleExecutions(UtmAlertResponseRuleExecutionCriteria criteria, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-alert-response-rule-executions");
