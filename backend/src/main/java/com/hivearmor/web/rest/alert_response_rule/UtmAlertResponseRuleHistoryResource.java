...
import com.hivearmor.service.alert_response_rule.UtmAlertResponseRuleHistoryQueryService;
import com.hivearmor.service.application_events.ApplicationEventService;
import com.hivearmor.service.dto.UtmAlertResponseRuleHistoryCriteria;
import com.hivearmor.service.dto.UtmAlertResponseRuleHistoryDTO;
...
public class UtmAlertResponseRuleHistoryResource {
    ...
    @GetMapping("/ha-alert-response-rule-histories")
    public ResponseEntity<List<UtmAlertResponseRuleHistoryDTO>> getAllAlertResponseRuleHistories(@ParameterObject UtmAlertResponseRuleHistoryCriteria criteria,
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-alert-response-rule-histories");
