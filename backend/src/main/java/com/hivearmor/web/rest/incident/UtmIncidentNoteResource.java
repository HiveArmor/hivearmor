...
import com.hivearmor.service.dto.incident.NewIncidentNoteDTO;
import com.hivearmor.service.dto.incident.UtmIncidentNoteCriteria;
import com.hivearmor.service.incident.UtmIncidentNoteQueryService;
import com.hivearmor.service.incident.UtmIncidentNoteService;
...
public class UtmIncidentNoteResource {
    ...
    public ResponseEntity<UtmIncidentNote> createUtmIncidentNote(@Valid @RequestBody NewIncidentNoteDTO newIncidentNoteDTO) throws URISyntaxException {
        ...
        try {
            ...
            return ResponseEntity.created(new URI("/api/ha-incident-notes/" + result.getId()))
    ...
    public ResponseEntity<List<UtmIncidentNote>> getAllUtmIncidentNotes(UtmIncidentNoteCriteria criteria, Pageable pageable) {
        ...
        try {
            ...
            HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-incident-notes");
