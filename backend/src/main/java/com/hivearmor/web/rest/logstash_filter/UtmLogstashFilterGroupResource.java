package com.hivearmor.web.rest.logstash_filter;

import com.hivearmor.domain.logstash_filter.UtmLogstashFilterGroup;
import com.hivearmor.service.dto.logstash_filter.UtmLogstashFilterGroupCriteria;
import com.hivearmor.service.logstash_filter.UtmLogstashFilterGroupQueryService;
import com.hivearmor.service.logstash_filter.UtmLogstashFilterGroupService;
...
public class UtmLogstashFilterGroupResource {
     ...
     */
    @PostMapping("/ha-logstash-filter-groups")
    public ResponseEntity<UtmLogstashFilterGroup> createUtmLogstashFilterGroup(@Valid @RequestBody UtmLogstashFilterGroup utmLogstashFilterGroup) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/ha-logstash-filter-groups/" + result.getId()))
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/ha-logstash-filter-groups")
     ...
     */
    @GetMapping("/ha-logstash-filter-groups")
    public ResponseEntity<List<UtmLogstashFilterGroup>> getAllUtmLogstashFilterGroups(UtmLogstashFilterGroupCriteria criteria, Pageable pageable) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ha-logstash-filter-groups");
    ...
    */
    @GetMapping("/ha-logstash-filter-groups/count")
     ...
     */
    @GetMapping("/ha-logstash-filter-groups/{id}")
     ...
     */
    @DeleteMapping("/ha-logstash-filter-groups/{id}")
