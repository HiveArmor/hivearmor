...
import com.hivearmor.domain.api_keys.ApiKeyUsageLog;
...
import com.hivearmor.service.mapper.ApiKeyMapper;
import com.hivearmor.util.exceptions.ApiKeyExistException;
import com.hivearmor.util.exceptions.ApiKeyNotFoundException;
...
import static com.hivearmor.config.Constants.V11_API_ACCESS_LOGS;
...
public class ApiKeyService {
    ...
    public static String hashKey(String plainKey) {
        try {
            ...
            byte[] hash = md.digest(plainKey.getBytes(java.nio.charset.StandardCharsets.UTF_8));
