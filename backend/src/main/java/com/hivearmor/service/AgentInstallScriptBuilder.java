...
public class AgentInstallScriptBuilder {
    ...
    private static final String POWER_SHELL_DOWNLOAD_BLOCK =
        ...
        + "  } catch {\n"
        + "    Write-Error \"Download failed from both $Url and $Fallback. Regenerate the script from the UI for self-signed staging hosts. Check firewall access to ports 443 and 9001.\"\n"
        + "    exit 1\n"
        + "  }\n"
        + "}\n"
