...
//                (MapPropertySource) mutablePropertySources.get(Constants.HIVEARMOR_PROPERTY_SOURCE_NAME);
...
//            MapPropertySource map = (MapPropertySource) propertySources.get(Constants.HIVEARMOR_PROPERTY_SOURCE_NAME);
