...
', '2026-03-02 22:50:04.982229', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.protoPayload.authenticationInfo.principalEmail","operator":"filter_term","value":"{{.log.protoPayload.authenticationInfo.principalEmail}}"}],"or":null,"within":"now-30m","count":10}]', '["lastEvent.log.protoPayload.methodName","adversary.user"]');
...
', '2026-03-02 22:50:07.344879', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.protoPayload.authenticationInfo.principalEmail","operator":"filter_term","value":"{{.log.protoPayload.authenticationInfo.principalEmail}}"}],"or":null,"within":"now-1h","count":2}]', '["lastEvent.log.protoPayload.methodName","adversary.user"]');
