...
', '2026-03-02 13:21:49.800468', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventCode","operator":"filter_term","value":"4663"},{"field":"origin.user","operator":"filter_term","value":"{{.origin.user}}"}],"or":null,"within":"now-5m","count":50}]', '["adversary.ip","adversary.user"]');
INSERT INTO public.utm_correlation_rules (id, rule_name, rule_confidentiality, rule_integrity, rule_availability, rule_category, rule_technique, rule_description, rule_references_def, rule_definition_def, rule_last_update, rule_active, system_owner, rule_adversary, rule_deduplicate_by_def, rule_after_events_def, rule_group_by_def) VALUES (887, 'Windows: Probable Password guessing', 2, 2, 3, 'Credential Access', 'T1110.001 - Brute Force: Password Guessing', 'Adversaries with no prior knowledge of legitimate credentials within the system or environment  may guess passwords to attempt access to accounts. Without knowledge of the password for an account,  an adversary may opt to systematically guess the password using a repetitive or iterative mechanism.  An adversary may guess login credentials without prior knowledge of system or environment passwords  during an operation by using a list of common passwords. Password guessing may or may not take into  account the target''s policies on password complexity or use policies that may lock accounts out after  a number of failed attempts.', '["https://attack.mitre.org/tactics/TA0006","https://attack.mitre.org/techniques/T1110/001/"]', 'oneOf("log.eventCode", [4625, 529, 530, 531, 532, 533, 534, 535, 536, 537, 539])', '2026-03-02 13:21:51.099967', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventCode","operator":"filter_term","value":"{{.log.eventCode}}"},{"field":"target.user","operator":"filter_term","value":"{{.target.user}}"}],"or":null,"within":"now-5m","count":10}]', '["adversary.ip","adversary.user"]');
INSERT INTO public.utm_correlation_rules (id, rule_name, rule_confidentiality, rule_integrity, rule_availability, rule_category, rule_technique, rule_description, rule_references_def, rule_definition_def, rule_last_update, rule_active, system_owner, rule_adversary, rule_deduplicate_by_def, rule_after_events_def, rule_group_by_def) VALUES (888, 'Windows: Multiple TS Gateway login failures', 3, 3, 2, 'Credential Access', 'T1110 - Brute Force', 'Adversaries may use brute force techniques to gain access to accounts when passwords are unknown or when password hashes are obtained.', '["https://attack.mitre.org/techniques/T1110/"]', 'equals("log.eventCode", 1001) && contains("log.message", "Microsoft-Windows-TerminalServices")', '2026-03-02 13:21:52.466461', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.ip","operator":"filter_term","value":"{{.origin.ip}}"}],"or":null,"within":"now-15m","count":10}]', '["adversary.ip","adversary.user"]');
...
', '2026-03-02 13:26:45.499847', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{.log.eventDataIpAddress}}"}],"or":null,"within":"now-15m","count":5}]', '["lastEvent.log.eventDataIpAddress","adversary.host"]');
...
', '2026-03-02 13:26:48.067827', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{.origin.host}}"}],"or":null,"within":"now-15m","count":3}]', '["adversary.host","adversary.process"]');
...
', '2026-03-02 13:26:49.391972', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{.log.eventDataIpAddress}}"}],"or":null,"within":"now-5m","count":3}]', '["lastEvent.log.eventDataIpAddress","adversary.host"]');
...
', '2026-03-02 13:26:50.707553', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{.log.eventDataIpAddress}}"},{"field":"log.eventCode","operator":"filter_term","value":"4624"}],"or":null,"within":"now-30m","count":3}]', '["lastEvent.log.eventDataIpAddress","adversary.host","adversary.user"]');
...
', '2026-03-02 13:26:51.792644', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{.origin.host}}"}],"or":null,"within":"now-30m","count":2}]', '["adversary.host","adversary.user"]');
...
', '2026-03-02 13:26:53.057252', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{.origin.host}}"}],"or":null,"within":"now-10m","count":2}]', '["adversary.host","adversary.user"]');
...
', '2026-03-02 13:26:54.099883', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{.origin.host}}"}],"or":null,"within":"now-15m","count":2}]', '["adversary.host","adversary.user"]');
...
', '2026-03-02 13:26:55.292640', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{.log.eventDataIpAddress}}"}],"or":null,"within":"now-15m","count":3}]', '["lastEvent.log.eventDataIpAddress","adversary.host"]');
...
', '2026-03-02 13:26:56.474938', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventDataSubjectUserName","operator":"filter_term","value":"{{.log.eventDataSubjectUserName}}"}],"or":null,"within":"now-1h","count":1}]', '["adversary.host","adversary.user"]');
...
!contains("origin.host", "DC")
', '2026-03-02 13:26:57.632855', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{.origin.host}}"}],"or":null,"within":"now-2h","count":2}]', '["lastEvent.log.eventDataSubjectUserName","adversary.host"]');
...
', '2026-03-02 13:26:58.868113', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{.origin.host}}"}],"or":null,"within":"now-30m","count":3}]', '["adversary.host","adversary.user"]');
...
', '2026-03-02 13:27:00.135533', true, true, 'origin', '["adversary.host","lastEvent.log.eventDataSubjectUserName"]', '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.host","operator":"filter_term","value":"{{.origin.host}}"}],"or":null,"within":"now-2h","count":10}]', null);
...
!regexMatch("target.user", "(?i)\\\\$$") &&
exists("target.user")
', '2026-03-02 13:27:01.581886', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{.log.eventDataIpAddress}}"}],"or":null,"within":"now-15m","count":3}]', '["lastEvent.log.eventDataIpAddress","adversary.host"]');
...
', '["https://learn.microsoft.com/en-us/windows-server/identity/ad-fs/troubleshooting/ad-fs-tshoot-logging","https://attack.mitre.org/techniques/T1078/"]', 'equals("log.providerName", "AD FS") && (equals("log.eventId", "411") || equals("log.eventId", "342") || equals("log.eventId", "516")) && contains("log.message", "token validation failed")', '2026-03-02 13:27:02.890185', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventDataIpAddress","operator":"filter_term","value":"{{.log.eventDataIpAddress}}"}],"or":null,"within":"now-10m","count":10}]', '["adversary.ip","target.user"]');
