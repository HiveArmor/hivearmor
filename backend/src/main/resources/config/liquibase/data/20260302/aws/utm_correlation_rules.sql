...
', '2026-03-02 19:28:13.989146', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.ip","operator":"filter_term","value":"{{.origin.ip}}"}],"or":null,"within":"now-15m","count":5}]', '["adversary.ip","adversary.user"]');
...
', '2026-03-02 19:28:15.419013', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.user","operator":"filter_term","value":"{{.origin.user}}"}],"or":null,"within":"now-15m","count":5}]', '["adversary.ip","adversary.user"]');
...
equals("log.errorCode", "")
', '2026-03-02 19:28:52.646279', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.sourceIPAddress","operator":"filter_term","value":"{{.log.sourceIPAddress}}"},{"field":"log.eventName","operator":"filter_match","value":"Describe List Get Generate"}],"or":null,"within":"now-10m","count":50}]', '["lastEvent.log.sourceIPAddress"]');
...
', '2026-03-02 19:28:53.957418', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.sourceIPAddress","operator":"filter_term","value":"{{.log.sourceIPAddress}}"}],"or":null,"within":"now-15m","count":20}]', '["lastEvent.log.userIdentityArn","adversary.ip"]');
...
equals("log.errorCode", "")
', '2026-03-02 19:28:55.353960', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.userIdentityArn","operator":"filter_term","value":"{{.log.userIdentityArn}}"},{"field":"log.eventSource","operator":"filter_term","value":"ssm.amazonaws.com"}],"or":null,"within":"now-30m","count":5}]', '["adversary.user","lastEvent.log.eventName"]');
...
equals("log.errorCode", "")
', '2026-03-02 19:28:59.249633', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.userIdentityArn","operator":"filter_term","value":"{{.log.userIdentityArn}}"},{"field":"log.eventName","operator":"filter_term","value":"GetObject"}],"or":null,"within":"now-15m","count":100}]', '["adversary.user","lastEvent.log.requestParameters.bucketName"]');
...
', '["https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/logging-using-cloudtrail.html","https://attack.mitre.org/techniques/T1584/002/"]', 'equals("log.eventSource", "route53.amazonaws.com") && equals("log.eventName", "ChangeResourceRecordSets") && equals("log.errorCode", "")', '2026-03-02 19:29:00.592800', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.userIdentityArn","operator":"filter_term","value":"{{.log.userIdentityArn}}"},{"field":"log.eventName","operator":"filter_term","value":"ChangeResourceRecordSets"}],"or":null,"within":"now-30m","count":10}]', '["lastEvent.log.sourceIPAddress","lastEvent.log.userIdentityArn"]');
...
', '["https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-concepts.html","https://attack.mitre.org/techniques/T1485/"]', '(contains("log.eventName", "Delete") || contains("log.eventName", "Terminate") || contains("log.eventName", "Remove")) && equals("log.errorCode", "") && !equals("log.eventSource", "s3.amazonaws.com")', '2026-03-02 19:29:01.863432', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.userIdentity.arn","operator":"filter_term","value":"{{.log.userIdentity.arn}}"}],"or":null,"within":"now-10m","count":15}]', '["lastEvent.log.sourceIPAddress","lastEvent.log.userIdentity.arn"]');
...
equals("log.errorCode", "")
', '2026-03-02 19:29:04.569454', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.userIdentityArn","operator":"filter_term","value":"{{.log.userIdentityArn}}"},{"field":"log.eventSource","operator":"filter_term","value":"iam.amazonaws.com"}],"or":null,"within":"now-30m","count":3}]', '["adversary.user","lastEvent.log.eventName"]');
...
', '2026-03-02 19:29:11.211276', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.sourceIPAddress","operator":"filter_term","value":"{{.log.sourceIPAddress}}"},{"field":"log.eventSource","operator":"filter_term","value":"sso.amazonaws.com"}],"or":null,"within":"now-30m","count":10}]', '["lastEvent.log.sourceIPAddress","lastEvent.log.userIdentity.principalId"]');
...
equals("log.errorCode", "")
', '2026-03-02 19:29:12.747199', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.userIdentityArn","operator":"filter_term","value":"{{.log.userIdentityArn}}"},{"field":"log.eventSource","operator":"filter_term","value":"ssm.amazonaws.com"}],"or":null,"within":"now-30m","count":5}]', '["adversary.user","lastEvent.log.eventName"]');
...
equals("log.errorCode", "") &&
!equals("log.userIdentityType", "AWSService")
', '2026-03-02 19:29:13.879754', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.userIdentityArn","operator":"filter_term","value":"{{.log.userIdentityArn}}"},{"field":"log.eventSource","operator":"filter_term","value":"securityhub.amazonaws.com"}],"or":null,"within":"now-30m","count":5}]', '["adversary.user","lastEvent.log.eventName"]');
...
equals("log.errorCode", "")
', '2026-03-02 19:29:15.012526', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.userIdentityAccountId","operator":"filter_term","value":"{{.log.userIdentityAccountId}}"}],"or":[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventName","operator":"filter_term","value":"UpdateSAMLProvider"}],"or":null,"within":"now-24h","count":1},{"indexPattern":"v3-hive-log-*","with":[{"field":"log.eventName","operator":"filter_term","value":"CreateSAMLProvider"}],"or":null,"within":"now-24h","count":1}],"within":"now-24h","count":1}]', '["adversary.user","lastEvent.log.requestParametersRoleArn"]');
...
', '2026-03-02 19:29:16.411056', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"log.sourceIPAddress","operator":"filter_term","value":"{{.log.sourceIPAddress}}"},{"field":"log.eventSource","operator":"filter_term","value":"ecs.amazonaws.com"}],"or":null,"within":"now-30m","count":5}]', '["adversary.user","lastEvent.log.sourceIPAddress"]');
