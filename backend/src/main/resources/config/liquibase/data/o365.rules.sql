...
', '2026-01-28 22:54:23.212737', true, true, 'origin', null, '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.user.keyword","operator":"filter_term","value":"{{.origin.user}}"},{"field":"action.keyword","operator":"filter_term","value":"Set-AdminAuditLogConfig"}],"or":[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.user.keyword","operator":"filter_term","value":"{{.origin.user}}"},{"field":"action.keyword","operator":"filter_term","value":"Remove-AdminAuditLogConfig"}],"or":null,"within":"now-24h","count":1}],"within":"now-24h","count":1}]', null);
...
', '2026-01-28 22:54:24.351490', true, true, 'origin', '["origin.user","origin.ip"]', '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.user.keyword","operator":"filter_term","value":"{{.origin.user}}"},{"field":"log.Workload.keyword","operator":"filter_term","value":"AzureActiveDirectory"}],"or":null,"within":"now-15m","count":10}]', null);
...
equals("actionResult", "Succeeded") &&
exists("log.action")
', '2026-01-28 22:54:29.551792', true, true, 'origin', '["origin.user"]', '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.user.keyword","operator":"filter_term","value":"{{.origin.user}}"},{"field":"log.action.keyword","operator":"filter_term","value":"{{.log.action}}"}],"or":null,"within":"now-1h","count":10}]', null);
...
', '2026-01-28 22:54:32.172440', true, true, 'origin', '["origin.user"]', '[{"indexPattern":"v3-hive-log-*","with":[{"field":"origin.user.keyword","operator":"filter_term","value":"{{.origin.user}}"},{"field":"action.keyword","operator":"filter_term","value":"Invite external user"}],"or":null,"within":"now-1h","count":5}]', null);
