...
// NOTE: This test file references SdkErrorFromResponse and calcSeverityFromStatus,
// which are not defined anywhere in the codebase (including the upstream go-sdk-main
// source it was copied from). It is gated with the "ignore" build tag so it does not
// break go vet / go build / go test. To reactivate, port the missing helpers into
// this package (see request.go) and remove the build tag above.
