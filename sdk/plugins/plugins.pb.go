...
type Event struct {
	...
	TenantPrefix     string                       `protobuf:"bytes,20,opt,name=tenantPrefix,proto3" json:"tenantPrefix,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Event) GetTenantPrefix() string {
	if x != nil {
...
type Tenant struct {
	...
	Prefix        string                 `protobuf:"bytes,5,opt,name=prefix,proto3" json:"prefix,omitempty"` // MSSP tenant index prefix — used in BuildTenantIndex(dataType, prefix)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_plugins_proto_rawDesc = "" +
	...
	"compliance\x12\"\n" +
	"\ftenantPrefix\x18\x14 \x01(\tR\ftenantPrefix\x1aN\n" +
	"\bLogEntry\x12\x10\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01\"\x92\x01\n" +
	"\x06Tenant\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12&\n" +
	"\x06assets\x18\x03 \x03(\v2\x0e.plugins.AssetR\x06assets\x12$\n" +
	"\rdisabledRules\x18\x04 \x03(\x04R\rdisabledRules\x12\x16\n" +
	"\x06prefix\x18\x05 \x01(\tR\x06prefix\"\xb7\x01\n" +
	"\x05Asset\x12\x12\n" +
	...
	"\vAlertOutput\x12\x0e.plugins.Alert\x1a\x16.google.protobuf.EmptyB\"Z github.com/hivearmor/sdk/pluginsP\x00P\x01b\x06proto3"
