...
const FrontEnd string = `server {
    ...
    set $ha_backend http://backend:8080;
    set $ha_agent_manager http://agentmanager:9001;
    set $ha_backend_auth http://backend:8080/api/authenticate;
    set $ha_ws http://backend:8080/ws;
