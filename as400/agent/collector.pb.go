...
const (
	...
	CollectorModule_HIVEARMOR CollectorModule = 1
)
...
type RegisterRequest struct {
	...
	// Required for new collector registrations. Bound into collector identity.
...
func (x *Collector) GetTenantId() int64 {
	if x != nil {
		return x.TenantId
	}
	return 0
...
const file_collector_proto_rawDesc = "" +
	"\n" +
	"\x0fcollector.proto\x12\x05agent\x1a\fcommon.proto\"\xaa\x01\n" +
	...
	"\tcollector\x18\x04 \x01(\x0e2\x16.agent.CollectorModuleR\tcollector\x12\x1b\n" +
	"\ttenant_id\x18\x05 \x01(\x03R\btenantId\"S\n" +
	...
	"\ttenant_id\x18\t \x01(\x03R\btenantId\"\x89\x01\n" +
	...
	"\n" +
	"\x06AS_400\x10\x00\x12\r\n" +
	"\tHIVEARMOR\x10\x012\xee\x02\n" +
	...
	"\x17RegisterCollectorConfig\x12\x16.agent.CollectorConfig\x1a\x16.agent.ConfigKnowledge\"\x00B*Z(github.com/hivearmor/agent-manager/agentb\x06proto3"
