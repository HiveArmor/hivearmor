...
export function AssetsPage(): JSX.Element {
  ...
  return (
    <section className="ast-page" data-fixture={assetFixtureMode || undefined} aria-label="Asset intelligence inventory">
      ...
      <StatusDock className="ast-status" sseConnected={assetFixtureMode || epsStream.connected} eps={assetFixtureMode ? 12840 : epsStream.eps} mode="live" lastUpdated={query.dataUpdatedAt ? new Date(query.dataUpdatedAt) : undefined} />
