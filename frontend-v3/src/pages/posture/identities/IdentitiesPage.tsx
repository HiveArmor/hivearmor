...
export function IdentitiesPage(): JSX.Element {
  ...
  return (
    <section className="idp-page" data-fixture={identityFixtureMode || undefined} aria-label="Identity security posture">
      ...
      <StatusDock className="idp-status" sseConnected={identityFixtureMode || eps.connected} eps={identityFixtureMode ? 12840 : eps.eps} mode="live" lastUpdated={query.dataUpdatedAt ? new Date(query.dataUpdatedAt) : undefined} />
