...
export function EntityDetailPage(): JSX.Element {
  ...
  return (
    <section className="entity-dossier">
      ...
      <div className="entity-dossier-status"><StatusDock sseConnected={epsStream.connected} eps={epsStream.eps} mode="live" lastUpdated={entity.riskCalculatedAt ? new Date(entity.riskCalculatedAt) : undefined} /><span><FileClock size={12} /> Risk snapshot {entity.riskCalculatedAt ? new Date(entity.riskCalculatedAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) : 'unavailable'}</span></div>
