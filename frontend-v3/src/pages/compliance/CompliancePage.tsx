...
export function CompliancePage(): JSX.Element {
  ...
  return <section className="cmp-page" aria-label="Compliance assurance">
    ...
    <StatusDock className="cmp-status-dock" sseConnected={eps.connected} eps={eps.eps} mode="historical" lastUpdated={frameworksQuery.dataUpdatedAt ? new Date(frameworksQuery.dataUpdatedAt) : undefined} />
