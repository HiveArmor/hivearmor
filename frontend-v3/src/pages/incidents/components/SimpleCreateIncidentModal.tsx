/**
 * SimpleCreateIncidentModal — Create incident without pre-selected alerts
 * For use on IncidentListPage "Create Incident" button
 */

import { useState } from 'react';

export interface SimpleCreateIncidentModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function SimpleCreateIncidentModal({
  isOpen,
  onClose,
  onSubmit,
}: SimpleCreateIncidentModalProps): JSX.Element | null {
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Create a new incident case for investigation
          </p>
        </div>
        ...
        >
          {error && (
            <div
              style={{
                padding: '12px',
                background: 'color-mix(in srgb, var(--ha-critical) 10%, transparent)',
