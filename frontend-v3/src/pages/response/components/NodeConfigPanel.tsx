      ...
      <div className="soar-inspector__scroll">
        ...
        {data.nodeType === 'approval' && (
          <section className="soar-config-section" aria-labelledby="config-approval">
            ...
            <label className="soar-field"><span>Required authority</span><select value={asString(config['authority'], 'ROLE_SOC_MANAGER')} onChange={(event) => updateConfig({ authority: event.target.value })}><option value="ROLE_SOC_MANAGER">SOC Manager</option><option value="ROLE_ADMIN">Platform Administrator</option></select></label>
